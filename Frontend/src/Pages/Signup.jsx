        ...
        <div className="flex justify-center">
          <div className="px-10 py-10 bg-[url('./assets/bg-image.jpg')] bg-cover bg-center rounded-lg">
            <div className="flex justify-center flex-col items-center">
              <h2 className="text-center text-3xl mb-0.5 tracking-widest text-lime-400">
                Signup
              </h2>
              <hr className="border border-lime-400 w-27 mb-9" />
              <form className="flex flex-col gap-6 items-center">
                <div className="name bg-white rounded-lg flex items-center">
                  <i class="fa-regular fa-circle-user pl-2 text-xl"></i>
                  <input
                    type="text"
                    placeholder="User name"
                    className="outline-0 b w-full py-2 text-center placeholder:text-center font-medium tracking-wider"
                  />
                </div>
